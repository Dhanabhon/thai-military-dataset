...
INSERT INTO "thai_military_ranks" VALUES ('RTA-AO-04-S', 'กองทัพบก', 'Royal Thai Army', 'ชั้นสัญญาบัตร', 'Commissioned Officer', 'ว่าที่พันเอก (พิเศษ)', 'Acting Senior Colonel', 'ว่าที่ พ.อ. (พิเศษ)', 'ACT SR COL');
...
INSERT INTO "thai_military_ranks" VALUES ('RTN-AO-04-S', 'กองทัพเรือ', 'Royal Thai Navy', 'ชั้นสัญญาบัตร', 'Commissioned Officer', 'ว่าที่นาวาเอก (พิเศษ)', 'Acting Senior Captain', 'ว่าที่ น.อ. (พิเศษ)', 'ACT SR CAPT');
...
INSERT INTO "thai_military_ranks" VALUES ('RTAF-AO-04-S', 'กองทัพอากาศ', 'Royal Thai Air Force', 'ชั้นสัญญาบัตร', 'Commissioned Officer', 'ว่าที่นาวาอากาศเอก (พิเศษ)', 'Acting Senior Group Captain', 'ว่าที่ น.อ. (พิเศษ)', 'ACT SR GP CAPT');
