...
ฐานข้อมูลชั้นยศทหารไทย (กองทัพบก กองทัพเรือ และกองทัพอากาศ) ในรูปแบบข้อมูลพร้อมใช้งาน (Open-source Dataset) ที่ออกแบบมาเพื่อให้นักพัฒนาซอฟต์แวร์ (Developers) สามารถนำไปต่อยอดได้ทันที

[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](http://makeapullrequest.com)

## เกี่ยวกับโปรเจกต์ (About)
โปรเจกต์นี้จัดทำขึ้นเพื่อรวบรวมข้อมูลชั้นยศทหารของประเทศไทยจากทั้ง 3 เหล่าทัพ ให้อยู่ในรูปแบบโครงสร้างข้อมูลมาตรฐาน (Structured Data) ซึ่งจะช่วยลดเวลาและภาระของนักพัฒนาที่ต้องการข้อมูลส่วนนี้ไปใช้ในระบบต่างๆ ไม่ว่าจะเป็น ระบบ HR, ระบบจัดการบุคลากร, แอปพลิเคชัน หรือแม้แต่งานวิเคราะห์ข้อมูล (Data Analytics)
...
```
*อธิบายฟิลด์ข้อมูล:*
- `id`: รหัสอ้างอิงของยศ (ไม่ซ้ำกัน)
- `branch_th` / `branch_en`: ชื่อเหล่าทัพ (ภาษาไทย/อังกฤษ)
- `type_th` / `type_en`: ประเภทชั้นยศ เช่น ชั้นสัญญาบัตร, ชั้นประทวน
- `rank_th` / `rank_en`: ชื่อชั้นยศเต็ม (ภาษาไทย/อังกฤษ)
- `abbr_th` / `abbr_en`: ตัวย่อชั้นยศ (ภาษาไทย/อังกฤษ)

## การนำไปใช้งาน (Getting Started)
1. Clone repository นี้ไปยังเครื่องของคุณ
```bash
git clone https://github.com/Dhanabhon/thai-military-rank-dataset.git
```
